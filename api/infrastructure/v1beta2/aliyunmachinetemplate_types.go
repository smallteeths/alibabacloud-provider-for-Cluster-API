...
// AliyunMachineSpec 控制器会把这些字段映射到 Upjet ecs.Instance.spec.forProvider
...
var (
	...
	AliyunMachineTemplateKindAPIVersion   = AliyunMachineTemplateKind + "." + "v1beta2"
	AliyunMachineTemplateGroupVersionKind = schema.GroupVersion{Group: "infrastructure.cluster.x-k8s.io", Version: "v1beta2"}.WithKind(AliyunMachineTemplateKind)
)
